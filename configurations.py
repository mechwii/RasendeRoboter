    ...
    },
{
        ...
        "targets": [
            {"position": (8, 4), "color": "Re"},
            {"position": (6, 6), "color": "Bl"},
            {"position": (3, 10), "color": "Gr"},
            {"position": (14, 12), "color": "Ye"},
        ],
    },
    {
        "robots": [
        ...
        "targets": [
            {"position": (1, 13), "color": "Bl"},
            {"position": (3, 5), "color": "Bl"},
            {"position": (13, 9), "color": "Gr"},
            {"position": (11, 1), "color": "Bl"},

        ],
    },
    {
        "robots": [
            {"position": (6,0), "color": "Re"},
            {"position": (0, 10), "color": "Bl"},
            {"position": (0, 7), "color": "Gr"},
            {"position": (14, 12), "color": "Ye"},
        ],
        "walls": [
            (0,5,'R'), (0,9,'R'),
